...
class AI_util:
    ...
    #   *** Do not modify the code above ***
        ...
        #   5) Remove the stopwords (use *self.stop_words)
            ...
            paragraph = paragraph.lower() #1
            tokenized_paragraph = word_tokenize(paragraph) #2
            tokenized_paragraph = nltk.pos_tag(tokenized_paragraph) #3
            tokenized_paragraph = [word for word, tag in tokenized_paragraph if tag in self.extract_specific_tags] #4
            tokenized_paragraph = [word for word in tokenized_paragraph if not word in self.stop_words] #5
